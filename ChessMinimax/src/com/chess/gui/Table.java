...
import com.chess.engine.classic.player.ai.MoveStrat;
import com.chess.engine.classic.player.ai.StandardBoardEval;
...
public final class Table extends Observable {
    ...
    private Color lightTileColor = Color.decode("#A89968");
    private Color darkTileColor = Color.decode("#041E42");

    private static final Dimension OUTER_FRAME_DIMENSION = new Dimension(850, 800);
            ...
            implements Observer
    {
                           ...
                           final Object arg)
        {
            ...
            {
                System.out.println(Table.get().getGameBoard().currentPlayer() + " Thinking....");
    ...
    private static class AIThinkTank extends SwingWorker<Move, String>
    {
        ...
        {
            final MoveStrat minimax = new Minimax(4);
            final Move bestMove = minimax.exe(Table.get().getGameBoard());
